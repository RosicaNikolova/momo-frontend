# Momo Frontend - Bedsense Insights Application
...
> **Note**: For full functionality, run the [momo-backend](https://github.com/RosicaNikolova/momo-backend) on `http://localhost:8000`. The app falls back to local mock data when backend is unavailable.
...
├── src/
│   ├── components/
│   │   ├── TrendDisplay.jsx        # Trend comparison view
│   │   ├── ChangepointsDisplay.jsx # Pattern shift detection
│   │   ├── AnomaliesDisplay.jsx    # Anomaly detection view
...
│   ├── pages/
│   │   ├── HomePage.jsx            # Detailed dashboard
...
Graduation project developed at Futures Lab (MindLabs Tilburg) in collaboration with Momo Medical to help caregivers make data-driven decisions and improve resident wellbeing.
